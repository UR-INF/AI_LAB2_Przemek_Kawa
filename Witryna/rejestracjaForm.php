...
<div class="container">	
 <div class="row content bg-success text-center"  >
	...
	<div class="col-sm">
	<br>
		<form method="post" name="rejestr" action="rejestPOST.php" >
		...
		<div class="form-group">
		  <input  type="email" class="form-control" name="email" id="email"  placeholder="Email" required="required" > 
			<?php if(isset($_SESSION['badmail'])) echo $_SESSION['badmail'];
		...
		<div class="form-group">
		  ...
		  <?php if(isset($_SESSION['notmatch'])) echo $_SESSION['notmatch'];
		...
		<div class="form-group">
		  <input type="submit" value="Rejestruj" name="rejestr" id="rejestr" class="btn btn-dark btn-lg">
		</div>
	   
	  </form>
	  <?php if(isset($_SESSION['rejsukces']))
	  {
		  echo $_SESSION['rejsukces'];
		  unset ($_SESSION['rejsukces']);
	  }
